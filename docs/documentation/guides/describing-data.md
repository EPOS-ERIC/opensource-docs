...
We will dissect a real-world example: a metadata file for an OGC Web Map Service (WMS). This is one of the examples loaded when you run the `epos-opensource docker populate --example` command from the [Quickstart Guide](../quickstart/index.md).
